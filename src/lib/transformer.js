...
function traverser(ast, visitor) {
  ...
  function traverseNode(node, parent) {
    ...
    try {
      ...
      console.log("missing ".concat(node.type, " case in traverseNode.operationsByType"));
      console.log(error);
    }
  ...
  traverseNode.operationsByType = {
    ...
    UserDefinedTypeName: function UserDefinedTypeName() {},
    ElementaryTypeName: () => {},
    ArrayTypeName: node => {
